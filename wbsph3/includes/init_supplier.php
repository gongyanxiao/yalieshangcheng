...
if ($_GET['suppId'] > 0) {
    $supplier_data_load = load_config_supplier();
    unset($supplier_data_load["shop_name"]);   //shop_address
    unset($supplier_data_load["shop_address"]);   //shop_address
    $_CFG = array_merge($_CFG, $supplier_data_load);
