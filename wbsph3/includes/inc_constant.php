...
/*用户类型*/
define('USER_TYPE_NORMAL',         0);//正常用户
define('USER_TYPE_XU_NI',          1);//虚拟用户
define('USER_TYPE_HE_BEI',         2);//河北用户
define('USER_TYPE_HE_BEI',         3);//后付费用户
...
define('PAY_PRODUCT_SURPLUS',       5); // 产品报单中心会员预付款
...
define('GAT_CHOU_JIANG',             6); // 抽奖活动

/* 帐号变动类型 */
define('ACT_SAVING',                0);     // 帐户冲值
define('ACT_DRAWING',               1);     // 帐户提款
define('ACT_ADJUSTING',             2);     // 调节帐户(系统调整)
define('ACT_DRAWING_FEN_HONG',      3);     // 大家庭分红提款
define('ACT_DRAWING_GZ',            4);     // 工资提款(基数奖励)
define('ACT_DRAWING_HK',            5);     // 货款提款
define('ACT_DRAWING_YANG_LAO',      6);     // 养老金申请
define('ACT_DRAWING_FEN_HONG_JI_FEN',      7); // 分红积分提款
define('ACT_DRAWING_CHAN_PIN_JI_FEN',      8); // 产品积分提款
define('ACT_DRAWING_FEN_XIANG_JI_FEN',      9); // 分享奖励积分提款
define('ACT_DRAWING_GOU_WU_QUAN',      10); // 购物券提款

define('ACT_REWARD_EVERY_DAY',      25);     // 每日赠送
define('ACT_REWARD_DJTTJJL',        26);     // 大家庭推荐奖励(推荐赠送)
define('ACT_REWARD_ZD',             27);     // 做单
define('ACT_CENTERDZ',             28);     // 运营中心奖励基数 
define('ACT_JRDJT',                29);     // 加入大家庭
define('ACT_LQHB',                30);     // 领取红包
define('ACT_CHJFCZ',              31);     //产品积分充值
define('ACT_FEN_XIANG_JIANG_LI',  32);//分享奖励积分
define('ACT_GOU_WU_QUAN',  33);//分享奖励积分
