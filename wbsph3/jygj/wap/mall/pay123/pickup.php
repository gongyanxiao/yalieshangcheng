...
$sql3="select * from zt_cz where ddbh='$orderNo' order by id desc";
$q3=mysql_query($sql3);
...
$sql="INSERT INTO  `zt_cz`(`id`,`ddbh`,`czmc`,`je`,`czrq`,`user`,`zt`,`sf`)VALUES(null,'$orderNo','商家会员充值','$orderAmount','$date','$user','1','$sf');";
