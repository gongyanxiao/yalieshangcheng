...
$sql1="update xbmall_users set xfjf='$xfjf1' where user='$user';";
$q1=mysql_query($sql1);
if($q1){
//记录转换日志
...
print("<script language='javascript'>window.location.href='jfzh.html';</script>");
exit();
	}
	}else{
