...
<body onload="sub();">	
<center> <font size=16><strong>聚元国际手机端支付</strong></font>
</center>
<?php
session_start();
//判断权限
...
$user=$_COOKIE['ECS']['username'];
if($user<>""){
$sql="INSERT INTO  `zt_cz`(`id`,`ddbh`,`czmc`,`je`,`czrq`,`user`,`zt`,`sf`)VALUES(null,'$orderNo','商家会员充值','$orderAmount1','$orderDatetime','$user','8','$sf');";
...
<table class="table_box" width="90%" align="center" style="display:none;">
