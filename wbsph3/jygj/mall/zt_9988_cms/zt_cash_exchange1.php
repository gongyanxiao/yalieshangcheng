...
if($yh=="13283727779"){
?>
content:'&nbsp;&nbsp;&nbsp;&nbsp;<select name="sh" id="sh"><option value="4">已通过</option><option value="3">已驳回</option></select><br>备注:<textarea name="bz" id="bz" cols="45" rows="5"></textarea><br>',
<?php
}else{
?>
...
<table width="100%" border="0" height="32px;" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="98%" align="left" background="images/position2.jpg">您当前的位置 >>提现记录&nbsp;总计：<a href="zt_cash_nsh.php">
...
$sq2="select sum(je) as ze from zt_b_cash_record  where zt='0' and ck<>'4'";
$qs2=mysql_query($sq2);
$sf2=mysql_fetch_assoc($qs2);
echo number_format($sf2['ze'],2);
...
echo $sf1x['khdz'].$sf1x['zhihang'];
    ...
    <td align="center" bgcolor="#FFFFFF" class="bk">
		  <?php
if($_COOKIE['zt_user2']=="13283727779"){
	  ?>
