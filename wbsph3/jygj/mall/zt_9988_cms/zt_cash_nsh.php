...
$phpfile = 'zt_cash_nsh.php';
$page= isset($_GET['page'])?$_GET['page']:1;

if($so<>"" or $sh1<>""){
if($so==""){
$q="select *  from zt_b_cash_record where zt='0'   order by id desc";
}else{
$q="select *  from zt_b_cash_record  where (user like '%$so%')   and zt='0'    order by id desc";
}
...
if($so<>"" or $sh1<>""){
if($so==""){
$query1="select *  from zt_b_cash_record  where  zt='0'  order by id desc limit $page,1000";
}else{
$query1="select *  from zt_b_cash_record where (user like '%$so%' )  and zt='0'  order by id desc limit $page,12";
}
}else{
$query1="select *  from zt_b_cash_record where    zt='0'  order by id desc limit $page,12";
}
