...
//增加商品
function add(){
location.href="zt_jifen_add.php";
	}
// --> 
</script> 
...
<table width="100%" border="0" height="22px;" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="98%" align="left" background="images/position2.jpg">您当前的位置>>积分商品管理&gt;&gt;&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="11%" height="32" align="center" bgcolor="#CAEEFF" ><input type="submit" name="button2" id="button2" value="增加积分商品" style="background-color:#F63;color:#FFF;border:0px;line-height:14px;height:22px; cursor:hand;" onclick="add();"/>
      &nbsp;</td>
    <td width="82%" align="left" bgcolor="#CAEEFF" >
...
<tr>
  ...
  <td height="29" align="center" bgcolor="#FFFFFF" class="bk"><span class="btdx">积分商品名称</span></td>
  <td height="29" align="center" bgcolor="#FFFFFF" class="bk"><span class="btdx">国内/国际</span></td>
  <td width="8%" align="center" class="bk"><span class="btdx">商品编号</span></td>
  <td width="6%" align="center" class="bk"><span class="btdx">兑换积分</span></td>
  <td width="6%" align="center"  class="bk"><span class="btdx">市场参考价</span></td>
  <td width="8%" align="center"  class="bk"><span class="btdx">积分首页推荐</span></td>
...
if($delid<>""&&$_POST['xm']==''){
$sql1="delete  from zt_jifen where id='$delid';";
...
$phpfile = 'zt_jifen_list.php';
$page= isset($_GET['page'])?$_GET['page']:1;
if($so<>""){
$q="select *  from zt_jifen  where (spmc like '%$so%') ".$key." order by id desc";
}else{
$q="select *  from zt_jifen where  id<>'' ".$key." order by id desc";
}
$query=mysql_query($q);
...
if($so<>""){
$query1="select *  from zt_jifen where (spmc like '%$so%') ".$key." order by id desc limit $page,12";

}else{
$query1="select *  from zt_jifen  where id<>'' ".$key." order by id desc limit $page,12";
}
...
echo $sf1['columname'];
    ...
    <td width="11%" align="center" bgcolor="#FFFFFF" class="bk"><span class="bk" style="color:red;">
    <?php if($row1['gngj']=='1'){
    echo "国际积分商品";
    }else{
        echo "国内积分商品";
...
echo $row1['dhjf']?></span></td>
    <td align="center" bgcolor="#FFFFFF" class="bk"><span>￥<?php echo 

$row1['ckj']?></span></td>
    <td align="center" bgcolor="#FFFFFF" class="bk"><span><?php if($row1['sfxptj']=='1'){
    echo "√";
    }else{
        echo "×";
    }?></span></td>
...
?>
    ...
    <td align="center" bgcolor="#FFFFFF" class="bk"><?php echo $row1['fbrq']?></td>
    <td align="center" bgcolor="#FFFFFF" class="bk"><?php echo $row1['username']?></td>

    <td align="center" bgcolor="#FFFFFF" class="bk"><img src="images/mod.jpg"><a href="zt_jifen_mod.php?id=<?=$row1
...
location.href="/mall/zt_9988_cms/zt_jifen_list.php"
} 
} 
</SCRIPT>
