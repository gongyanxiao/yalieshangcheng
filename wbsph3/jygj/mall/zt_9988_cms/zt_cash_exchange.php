...
mysql_select_db($db_database);
									$sq2="select sum(je) as ze from zt_b_cash_record";
$qs2=mysql_query($sq2);
...
$phpfile = 'zt_cash_exchange.php';
$page= isset($_GET['page'])?$_GET['page']:1;

if($so<>"" or $sh1<>""){
if($so==""){
$q="select *  from zt_b_cash_record    order by id desc";
}else{
$q="select *  from zt_b_cash_record  where (user like '%$so%')    order by id desc";
}
...
if($so<>"" or $sh1<>""){
if($so==""){
$query1="select *  from zt_b_cash_record  order by id desc limit $page,1000";
}else{
$query1="select *  from zt_b_cash_record where (user like '%$so%' ) order by id desc limit $page,12";
}
}else{
$query1="select *  from zt_b_cash_record  order by id desc limit $page,12";
}
