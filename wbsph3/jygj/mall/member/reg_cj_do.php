...
$sql="select  user_name from  xbmall_users where user_name='{$tuiJianRenAcc}'";
...
$sql = "select  * from `xbmall_users` WHERE `user_name` = '$username' and is_cj=1 order by id desc";
...
$sql3= "select  * from xbmall_users where sfzh='$sfzh' and is_cj=1 order by id desc";
...
$query99="insert into xbmall_users(`id`,`user_name`,`pass`,`ip`,`role`,`ssfl`,`state`,`tx`,`xm`,`zsq`,`yzs`,`zcrq`,`sfzh`,";
