...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="聚元国际集团网站管理系统"><img src="/images/logo.png" border="0"></a></div></TD>
		<TD height="60"> 
...
<div align="center"><font color="#FFFFFF"><strong>插件</strong></font></div></td>
					...
					<TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doshopmenu');window.open('http://www.jsguoji.cn/mall/zt_9988_cms/');" style="CURSOR: hand;<?=$showshopmenu?'':'display:none'?>" id="doshopmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
