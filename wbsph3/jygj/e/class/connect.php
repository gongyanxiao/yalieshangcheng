...
function ReturnClassLink($classid){
	...
	$string="<li><span><a href=\"".ReturnSiteIndexUrl()."\">".$fun_r['index']."</a></span></li>";
	for($i=1;$i<count($r)-1;$i++)
	{
		...
		if($i>=3){
			$string.="&nbsp;<li><span>".$public_r[navfh]."</span></li>&nbsp;<li><a href=\"".$url."\">".$class_r[$r[$i]][classname]."</a></li>";	
		}
	}
	return $string;
}
...
function ReturnZtLink($ztid){
    ...
    $string.="&nbsp;<li><span>".$public_r[navfh]."</span></li>&nbsp;<li><a href=\"".$url."\">".$class_zr[$ztid][ztname]."</a></li>";
	return $string;
}
...
function ReturnInfoTypeLink($typeid){
    ...
    $string.="&nbsp;<li><span>".$public_r[navfh]."</span></li>&nbsp;<li><a href=\"".$url."\">".$class_tr[$typeid][tname]."</a></li>";
	return $string;
}
...
function ReturnUserPLink($title,$titleurl){
	...
	$string='<li><a href="'.ReturnSiteIndexUrl().'">'.$fun_r['index'].'</a></li>&nbsp;<li><span>'.$public_r[navfh].'</span></li>&nbsp;'.$title;
	return $string;
}
