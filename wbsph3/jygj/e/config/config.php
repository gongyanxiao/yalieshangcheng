...
// $ecms_config['db']['dbusername']='xbshp';	//数据库用户名
// $ecms_config['db']['dbpassword']='F8a9h7x209988';	//数据库密码

$ecms_config['db']['dbusername']='root';	//数据库用户名
$ecms_config['db']['dbpassword']='root';	//数据库密码
$ecms_config['db']['dbname']='xbshp';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='QDEGHfBkeBLtb1wedZOGwwiLzRqulb';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='uutya';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='bqicq';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='NWQvztAk6FmntxapdC3JrPJkDBEPQK';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='H2BpYZ5PAqpi5lA1pL6pBPjJEh9Dm2';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'聚元国际|安徽诺斯贝尔电子商务有限公司',
'newsurl'=>'/',
'filetype'=>'|.gif|.jpg|.swf|.rar|.zip|.mp3|.wmv|.txt|.doc|.mp4|.flv|',
'filesize'=>90960,
'relistnum'=>8,
'renewsnum'=>100,
'min_keyboard'=>2,
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'p2bJI6OxXpLkTlhUnNXmLDI6sGrIb1',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/zizhirongyu/\">资质荣誉</a>&nbsp;|&nbsp;<a href=\"/qiyejianjie/\">企业简介</a>&nbsp;|&nbsp;<a href=\"/zuzhijiagou/\">组织架构</a>&nbsp;|&nbsp;<a href=\"/yunzuomoshi/\">运作模式</a>&nbsp;|&nbsp;<a href=\"/bangonghuanjing/\">办公环境</a>&nbsp;|&nbsp;<a href=\"/guanyuwomen/\">关于我们</a>&nbsp;|&nbsp;<a href=\"/cishangongyi/\">慈善公益</a>&nbsp;|&nbsp;<a href=\"/shipinzhongxin/\">视频中心</a>&nbsp;|&nbsp;<a href=\"/e/action/ListInfo/?classid=9\">聚元商城</a>&nbsp;|&nbsp;<a href=\"/yinsishengming/\">隐私声明</a>&nbsp;|&nbsp;<a href=\"/lianxiwomen/\">联系我们</a>&nbsp;|&nbsp;<a href=\"/wangzhanditu/\">网站地图</a>&nbsp;|&nbsp;<a href=\"/wangzhanrenzheng/\">网站认证</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'qenter'=>',ftitle,special.field,titlepic,smalltext,writer,befrom,newstext,',
...
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,province,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,province,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|1|2|3|4|5|6|7|10|11|36|37|38|39|40|71|44|45|70|',
'tid'=>1,
'tbname'=>'news');
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,',
'qenter'=>',',
'listtempf'=>',title,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,psalenum,',
'tempf'=>',title,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,psalenum,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,productno,pbrand,intro,price,newstext,',
'cj'=>',title,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,',
'canaddf'=>',title,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,',
'caneditf'=>',title,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,guige,shouhou,province,morepic,titlepic,productpic,newstext,',
'tbmainf'=>',title,titlepic,newstime,productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,productpic,newstext,psalenum,guige,shouhou,province,morepic,',
'tbdataf'=>',',
'tobrf'=>',intro,newstext,shouhou,',
'dohtmlf'=>',productno,pbrand,intro,unit,weight,tprice,price,buyfen,pmaxnum,productpic,newstext,psalenum,guige,shouhou,province,morepic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,guige,',
'ubbeditorf'=>',',
'pagef'=>'newstext',
'smalltextf'=>',',
'filef'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,video,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'qenter'=>',',
'listtempf'=>',title,ftitle,video,newstime,titlepic,smalltext,diggtop,',
'tempf'=>',title,ftitle,video,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,ftitle,video,',
'cj'=>',',
'canaddf'=>',title,ftitle,video,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'caneditf'=>',title,ftitle,video,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'tbmainf'=>',newstime,ftitle,titlepic,title,smalltext,diggtop,video,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,video,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
