...
<meta charset="UTF-8">
    ...
    <script type="text/javascript" src="[!--news.url--]Public/home/js/jquery.flexslider-min.js"></script>
    <script type="text/javascript" src="[!--news.url--]Public/home/js/MSClass1.65.js"></script>
...
<h1 label="标题居中" style="font-size: 32px;
		...
		text-align: center;margin-bottom: 20px;"><span style="font-size: 16px;
		line-height: 1.5em;
		text-indent: 2.2em;
		color: rgb(0, 112, 192);
		...
		[!--class.name--]</span></strong></span></h1>
            <div class="spzx">
                <div class="spzx_con"><a href="/shipinzhongxin/2017-01-09/124.html"  target="_blank">
                    <div class="spzx_l" style="background: url([!--news.url--]images/index.jpg);background-size: 100% 100%">
                    ...
                    <div class="spzx_r">
                        ...
                        <p>
                            安徽诺斯贝尔电子商务有限公司（以下简称公司）是互联网+模式创新迅速发展中组建的创新型平台化电子商务企业。“诺斯贝尔网络服务平台”是我们倾力打造的互联网公众品牌。
“好雨知时节，当春乃发生。”一场互联网+的好雨，滋润创新型电商企业万笋劲拔，千绿碧野。我们就是一支在“好雨”中应运而生的崭新团队，面向全国，用虔诚之心并以严谨科学的专业精神，为我们的上帝----实体店商和消费者服务
                        </p>
                    </div>
