...
<head lang="en">
    ...
    <meta name="keyword" content="<?=$ecms_gr[keyboard]?>"/>
...
<div class="warp_p">
        <div class="warp_p_home">
                        ...
                        <div class="warp_p_right_ul_li_4">
                            ...
                            <div class="warp_p_right_ul_li_5">
                                <div class="warp_p_right_ul_li_6">
                                    <a href="#">
                                        <img src="/jygj/Public/home/img/im3.jpg">
                                        <span>中文</span>
                                    </a>
                                </div>
                                <ul class="warp_p_right_ul_li_7">
                                    <li>
                                        <a href="#">
                                            <img src="/jygj/Public/home/img/im3_1.jpg">
                                            <span>英文</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="/jygj/Public/home/img/im3_2.jpg">
                                            <span>俄文</span>
                                        </a>
                                    </li>
                                </ul>
            ...
            <span class="warp_p_home_sp">您好，欢迎来到聚升国际			<a href="/e/member/login/index.php">[登陆]</a><a href="/e/member/register/ChangeRegister.php">[注册]</a>
						</span>
        </div>
    </div>
<div class="warp_o">
	...
	<div class="warp_o_home">
		...
		<a href="shop.html" title="聚升国际|黑龙江克络诺斯电子商务有限公司" class="warp_o_logo"><img src="/images/logo.png" width="224" height="88" alt=""></a>
				...
				<ul class="warp_u_rigt_gp">
					<li>
						<a href="member/center.html">
							<img src="/jygj/Public/home/img/im19.png" width="40" height="40">
							<span>会员中心</span>
						</a>
					</li>
					<li>
						<a href="business/orderlist.html">
							<img src="/jygj/Public/home/img/im21.png" width="40" height="40">
							<span>商家中心</span>
						</a>
					</li>
					<li>
						<a href="agent/index.html">
							<img src="/jygj/Public/home/img/im20.png" width="40" height="40">
							<span>代理中心</span>
						</a>
					</li>
				</ul>
...
<li class="warp_u_div_li">
	<div class="warp_u_div_mp">
		...
		if($xral<4){
		?>
			<a href="/e/action/ListInfo/?classid=<?=$class_r[$xra[1]]['classid']?>"  title="<?=$class_r[$xra[0]]['classname']?>" target="_blank"><?=$class_r[$xra[1]]['classname']?></a>
		<?			
		} else {
		?>
			<a href="/e/action/ListInfo/?classid=<?=$xra[$xral-2]?>"  title="<?=$class_r[$xra[$xral-1]]['classname']?>" target="_blank"><?=$class_r[$xra[$xral-2]]['classname']?></a>	
			<a href="/e/action/ListInfo/?classid=<?=$xra[$xral-3]?>"  title="<?=$class_r[$xra[$xral-2]]['classname']?>" target="_blank"><?=$class_r[$xra[$xral-3]]['classname']?></a>	
		<?
		}
		?>
		</div>
	...
	<ul class="warp_u_div_sj_<?=$x+1?>">
		<li class="warp_u_div_sj_li">
			...
			<div class="col_f1">
				<dl class="fixed">
					<dt><a href="/e/action/ListInfo/?classid=<?=$rb[classid]?>" title="<?=$rb['classname']?>" target="_blank"><?=$rb[classname]?></a></dt>
					<?
					if($rb[sonclass]!='') {
					?>
					<dd>
					...
					?>
						<a href="/e/action/ListInfo/?classid=<?=$rc[classid]?>" title="<?=$rc['classname']?>" target="_blank"><?=$rc[classname]?></a>
					<?
						}
					?>
					</dd>
...
<ul class="warp_u_ul">
	<li class="warp_u_li">
		<a href="/<?=$class_r[9]['classpath']?>" class="warp_u_li_bt">首页</a>
	</li>
	<li class="warp_u_li">
		<a href="/e/action/ListInfo/?classid=23"  title="联盟商家区" target="_blank" class="warp_u_li_bt">联盟商家区</a>
	</li>
	<li class="warp_u_li">
		<a href="/e/action/ListInfo/?classid=24"  title="产品列表区" target="_blank" class="warp_u_li_bt">产品列表区</a>
	</li>
	<li class="warp_u_li">
		<a href="/e/action/ListInfo/?classid=25"  title="特色产品展示区(现金购买)" target="_blank" class="warp_u_li_bt">特色产品展示区</a>
		<ul class="warp_u_ml">
	...
	<li class="warp_u_li">
		<a href="/e/action/ListInfo/?classid=28"  title="积分兑换区" target="_blank" class="warp_u_li_bt">积分兑换区</a>
	</li>
	<li class="warp_u_li">
		<a href="/e/action/ListInfo/?classid=29"  title="会员互动区" target="_blank" class="warp_u_li_bt">会员互动区</a>
		<ul class="warp_u_ml">
	...
	<li class="warp_u_li">
		<a href="/" class="warp_u_li_bt">集团网站</a>
	</li>
    ...
    <div class="warp_moer">
        ...
        <div class="warp_j">
            <div class="warp_j_right">
               <div class="warp_f" style="margin-top: 12px">
...
<p align="center" class="pageLink">[!--page.url--]</p></td>
        ...
        <a href="" class="warp_l_gg_2"><img src="/jygj/Public/home/img/im89.jpg" width="1200" height="114"></a>
	...
	<div class="warp_e_more">
		...
		<div class="warp_e_div">
			<? 
				...
				?>
				<ul>
				<p style="background: url(/Public/home/img/im<?=$id+34?>.jpg) no-repeat left center;background-position: 40px"><?=$class_r[$id]['classname']?></p>
...
<div class="warp_e_db">
	<div style="width: 1200px;background: #444444;overflow: hidden;margin: auto;padding: 15px 0">
		<span>版权所有：<a href="/">安徽诺斯贝尔电子商务有限公司</a></span><span>技术支持：<a href="http://www.zt315.cn/" target="_blank">中天科技</a></span>
		...
		<div class="zj_p">
			<ul>
				...
				<li>
					<a href="http://t.knet.cn/index_new.jsp" target='_blank'><img src="/jygj/Public/home/img/kxwzsfyz.png"></a>
				</li>
				<li>
