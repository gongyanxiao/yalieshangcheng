...
<tr><td width='16%' height=25 bgcolor='ffffff'>省份</td><td bgcolor='ffffff'>
...
<tr>
    <td width=16% height=25 bgcolor=ffffff>规格及包装</td>
    <td bgcolor=ffffff>
<?=ECMS_ShowEditorVar("guige",$ecmsfirstpost==1?"":stripSlashes($r[guige]),"Default","","300","100%")?>
</td>
  </tr>
<tr>
    <td width=16% height=25 bgcolor=ffffff>售后服务</td>
    <td bgcolor=ffffff><textarea name="shouhou" cols="80" rows="10" id="shouhou"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[shouhou]))?></textarea>
</td>
  </tr>
  <tr>
