...
?>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>规格及包装正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--guige--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_guige]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_guige]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_guige]" type="text" id="add[z_guige]" value="<?=stripSlashes($r[z_guige])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>售后服务正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--shouhou--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_shouhou]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_shouhou]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_shouhou]" type="text" id="add[z_shouhou]" value="<?=stripSlashes($r[z_shouhou])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>省份正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--province--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_province]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_province]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_province]" type="text" id="add[z_province]" value="<?=stripSlashes($r[z_province])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
