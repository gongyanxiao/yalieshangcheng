...
$c = new TopClient;
//$sql="select value from ".$GLOBALS['ecs']->table("shop_config")." where code='appkey'";
$c->appkey =$GLOBALS['db']->getOne("select value from ".$GLOBALS['ecs']->table("shop_config")." where code='appkey'"); //$GLOBALS['_CFG']['appkey'];
$c->secretKey = $GLOBALS['db']->getOne("select value from ".$GLOBALS['ecs']->table("shop_config")." where code='secretKey'");//$GLOBALS['_CFG']['secretKey'];
$req = new AlibabaAliqinFcSmsNumSendRequest;
$req->setExtend("123456");
$req->setSmsType("normal");
$req->setSmsFreeSignName($GLOBALS['db']->getOne("select value from ".$GLOBALS['ecs']->table("shop_config")." where code='dayu_sign'"));//$GLOBALS['_CFG']['dayu_sign']
