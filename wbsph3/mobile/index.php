...
header("Location: /mobile/shop.php"); 
...
$smarty->assign('flash_count',count(get_flash_xml()));
    ...
    $sql = 'SELECT count(0) FROM ' . $ecs->table("users") . ' ';
    $userCont = $db->getOne($sql, true);
    $smarty->assign('userCont',$userCont);
