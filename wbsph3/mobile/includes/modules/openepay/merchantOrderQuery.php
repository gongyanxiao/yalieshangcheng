	...
	?>
		...
		require_once("d:\phpEnv\apache2.2\htdocs\openepay\php_rsa.php");  //请修改参数为php_rsa.php文件的实际位置
		
		require_once("d:\phpEnv\apache2.2\htdocs\openepay\HashMap.class.php");	//请修改参数为HashMap.class.php文件的实际位置
    ...
    $pageContents = "";
		...
		if($map->get("ERRORCODE") != ""){
			...
			$publickeyfile = 'd:\phpEnv\apache2.2\htdocs\openepay\publickey-dev.txt';
