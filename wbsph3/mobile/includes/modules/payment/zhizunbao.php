...
//         $key = "I4rpDZrwiI";
        ...
        $def_url = '<div style="text-align:center"><form name=form action="http://bao.appfu.net/mobile/ss/gatePayPage.do" method="post" OnSubmit="true">';
        ...
        $def_url .= "<input type='submit' name='submit' style=\"line-height: 12px;font-size:12px;display: inline-block;text-align: center;text-decoration: none;color: #fff;background-color: #E31939;overflow: visible;border: 0 none;outline: 0;padding: 7px;cursor: pointer	\" value='" . $GLOBALS['_LANG']['zhizunbao_pay_button'] . "' />";
        $def_url .= "</form></div></br>";
        return $def_url;
    }
