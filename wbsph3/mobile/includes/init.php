...
// 查询配置
$sql =" SELECT value FROM ".$GLOBALS['ecs']->table('shop_config')." WHERE `code` = 'shop_closed' ";
$_CFG['shop_closed'] = $GLOBALS['db']->getOne($sql);

$sql =" SELECT value FROM ".$GLOBALS['ecs']->table('shop_config')." WHERE `code` = 'close_comment' ";
$_CFG['close_comment'] = $GLOBALS['db']->getOne($sql);
...
if (!defined('INIT_NO_SMARTY')) {
    ...
    require(ROOT_PATH . 'includes/lib_uuecs.php');
    if (($ua == '' || preg_match($uachar, $ua)) && !strpos(strtolower($_SERVER['REQUEST_URI']), 'wap')) {
