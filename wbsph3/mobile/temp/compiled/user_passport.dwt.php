                            ...
                            <div class="Login">
                             ...
                             <!--   <dt>二级密码</dt>
                                ...
                                function change_p_pay_type(){
									if($("#p_pay_password").attr("type") == "password"){
 										$("#p_pay_type").addClass("on");
										document.getElementById("p_pay_password").type="text";						

									}
									else{
										$("#p_pay_type").removeClass("on");
										document.getElementById("p_pay_password").type="password";
									}
								}
                                </script>
                                <input type="password" name="pay_password" placeholder="密码" id="p_pay_password"/> </dd>
                                <span onclick="change_p_pay_type()" class="p_type" id="p_pay_type"></span>
                                --></dl>
