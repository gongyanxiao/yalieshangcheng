...
var RequestData = function (showLoading) {
    ...
    var data = { "des": "注释", "isSuc": true, 
    		"datas": { "USDCNY": 6.83, "contractUnit": "BTC", 
    			"data": [[1499875200000, 16580, 16700, 16530, 16700, 12.6415],
    				[1499875200000, 16680, 16200, 16730, 16900, 9.6415],
    				[1499875200000, 16552, 16980, 16130, 16400, 17.6415],
    				[1499875200000, 16580, 16700, 16530, 16700, 15.6415],
    				[1499875200000, 16580, 16700, 16530, 16700, 36.6415],
    				[1499875200000, 16580, 16700, 16530, 16700, 85.6415], 
    				[1499918040000, 16630, 16784, 16582, 16710, 42.6415], 
    				[1499918280000, 16580, 16700, 16530, 16700, 32.6415], 
    				[1499918400000, 16580, 16700, 16530, 16700, 22.6415], 
    				[1499918760000, 16580, 16700, 16530, 16700, 17.6415],
    				[1499919000000, 16548, 16860, 16430, 16800, 19.6415]],
    				"marketName": "香柏网", "moneyType": "CNY", "symbol": "btc38btccny",
    				"url": "官网地址", "topTickers": [] } }

    //生產即時點價格
    //randomNum
    //最高价
    var hight = randomNum(18000, 35000);
    //最低价
    ...
    var jishi = { "des": "注释", "isSuc": true, 
    		"datas": { "USDCNY": 6.83, "contractUnit": "BTC", 
    			"data": [[timestamp, open, hight, low, close, volume]], 
    			"marketName": "币柜网", "moneyType": "CNY", "symbol": "btc38btccny",
    			"url": "官网地址", "topTickers": [] } }
