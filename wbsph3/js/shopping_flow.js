...
function checkOrderForm(frm) {
    ...
    have_alipay = false;
    if (frm.elements['com_bank']) {
        for (var iii = 0; iii < frm.elements['com_bank'].length; iii++) {
            if (frm.elements['com_bank'][iii].checked) {
                have_alipay = true;
            }
        }
    }
    ...
    for (i = 0; i < frm.elements.length; i++) {
        ...
        // }
        if (frm.elements[i].name === 'hidPayDiv')
        {
            if (frm.elements[i].value * 1 === 0)
            {
            } else
            {
