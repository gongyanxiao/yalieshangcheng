...
$_LANG['22_large_area'] = '大区管理';
$_LANG['large_area'] = '大区管理';


$_LANG['23_users_role'] = '用户权限管理';
$_LANG['users_role'] = '用户权限管理';



$_LANG['role_offline'] = '做单';
$_LANG['role_offline_order'] = '线下订单';
$_LANG['role_points'] = '我的积分';
$_LANG['role_yl_points'] = '养老金';
$_LANG['role_goods'] = '我的商品';
$_LANG['role_orders'] = '我的订单';
$_LANG['role_account'] = '资金统计';
$_LANG['role_offline_man'] = '做单管理';
$_LANG['role_offline_statics'] = '做单统计';
$_LANG['role_offline_order_m'] = '线下订单管理';
$_LANG['role_points_man'] = '我的积分';
$_LANG['role_points_ex_man'] = '积分兑换';
$_LANG['3_role_points_gz_ex'] = '基数奖励兑换';
$_LANG['role_points_gz_ex'] = '基数奖励兑换';
$_LANG['role_yl_points_man'] = '养老金';
$_LANG['role_yl_points_apply'] = '养老金申请';
$_LANG['role_goods_man'] = '商品管理';
$_LANG['role_orders_man'] = '订单管理';
$_LANG['role_account_man'] = '资金统计';
$_LANG['z_dianpu_set'] = '店铺设置';


$_LANG['user_blanklist'] = '会员小黑屋';
$_LANG['30_accounts_manage'] = '账号管理';
$_LANG['accounts_manage'] = '账号管理';
$_LANG['1_user_manage'] = '用户管理';
$_LANG['2_online_suppliers'] = '线上商家';
$_LANG['3_offline_suppliers'] = '联盟商家';
$_LANG['4_city_manage'] = '城市经理管理';
$_LANG['5_large_area_manage'] = '大区经理管理';

$_LANG['31_scores_manage'] = '积分管理';
$_LANG['scores_manage'] = '积分管理';
$_LANG['1_scores_manage'] = '积分查看';
$_LANG['2_scores_recharge'] = '积分充值';
$_LANG['3_scores_exchange'] = '积分兑换';
$_LANG['4_scores_exchange_gz'] = '基数奖励兑换';
$_LANG['5_scores_exchange_djtfh'] = '大家庭分红兑换';


$_LANG['12_order_statics'] = '商家线下做单统计';
$_LANG['13_order_statics'] = '自营订单统计';
$_LANG['12_order_statics_up'] = '商家线上订单统计';
$_LANG['32_finance'] = '财务统计';
$_LANG['finance'] = '财务统计';
$_LANG['finance_statics'] = '网站应收账款统计';
$_LANG['statics_dong_jie'] = '消费冻结统计';
$_LANG['income_statics'] = '收入统计';
$_LANG['ji_fen_gou_wu_statics'] = '本人积分购物明细汇总';
$_LANG['ben_ren_statics'] = '个人金额统计';
$_LANG['tui_jian_statics'] = '推荐关系统计';


$_LANG['blacklist_manage'] = '会员小黑屋';
//members后台
...
$_LANG['invoice_manage'] = '发票列表';
$_LANG['back_order'] = '退货单列表';
$_LANG['edit_order_print'] = '订单打印';
$_LANG['cat_manage'] = '添加商品分类';

// admin 爱心互助
$_LANG['33_Mutual'] = '爱心互助';
$_LANG['1_insure'] = '投保列表';
$_LANG['2_mutual'] = '互助列表';
$_LANG['3_mutual'] = '助人列表';

$_LANG['34_pension'] = '养老金';
$_LANG['1_pension_manage'] = '养老金管理';
$_LANG['2_pension_apply'] = '养老金申请';
$_LANG['pension_manage_list'] = '养老金列表';
$_LANG['add_pension_manage'] = '新增养老金';
$_LANG['edit_pension_manage'] = '编辑养老金';
$_LANG['pension_name_exist'] = '养老金名称已存在';
$_LANG['continue_add_pension'] = '继续新增养老金';
$_LANG['back_pension_list'] = '返回养老金列表';
$_LANG['add_pension_ok'] = '新增养老金成功';
$_LANG['edit_pension_ok'] = '编辑养老金成功';
$_LANG['pension_apply_list'] = "养老金申请列表";
$_LANG['pension_apply_attradd_succed'] = '操作成功';


//天空项目
$_LANG['tk_ji_ben_xin_xi'] = '基本信息';
$_LANG['tk_ji_ben_xin_xi_base'] = '基本信息';
$_LANG['tk_ji_ben_xin_xi_zi_liao'] = '用户资料';
$_LANG['tk_chan_pin'] = '产品';
$_LANG['tk_chan_pin_list'] = '产品列表';
$_LANG['tk_chan_pin_buy_list'] = '产品购买记录';
$_LANG['tk_chan_pin_xiao_shou_list'] = '产品销售记录';
$_LANG['tk_chan_pin_xiao_shou_ti_xian_list'] = '销售提现记录';
$_LANG['tk_li_cai'] = '理财产品';
$_LANG['tk_li_cai_list'] = '理财产品列表';
$_LANG['tk_li_cai_buy_list'] = '理财产品购买列表';



// $_LANG['tk_admin_user'] = '甜空用户管理';
// $_LANG['tk_admin_shen_qing'] = '甜空用户申请';
// $_LANG['tk_admin_user_info'] = '甜空用户列表';
// $_LANG['tk_admin_li_cai_list'] = '理财产品列表';


$_LANG['jygj'] = '财务管理';
$_LANG['zt_user_cj_list'] = '超级会员';
$_LANG['xxtz_cz_list'] = '充值审核';
$_LANG['xxtz_list'] = '投资记录';
$_LANG['zt_cash_exchange_cj'] = '投资提现记录';
$_LANG['xxcz_fa_fang_manager'] = '聚珠发放管理';
$_LANG['zt_setting_list'] = '系统配置';
$_LANG['xxtzzs_list'] = '聚珠变动记录';
$_LANG['xxtz_tree'] = '测试';
$_LANG['tong_ji'] = '合伙人管理';
$_LANG['tong_ji_fen_hong'] = '每日收益统计';
$_LANG['tui_jian_jiang_fa_huo'] = '推荐奖发货';
$_LANG['cai_gou_ding_dan'] = '采购订单管理';
$_LANG['ru_ku_ding_dan'] = '入库订单管理';
$_LANG['ru_ku_chu_ku_tong_ji'] = '出入库统计';
$_LANG['xb_zrzcjl'] = '转入转出记录';
$_LANG['xb_pu_huo_ji_lu'] = '铺货记录';
$_LANG['xb_cai_wu_hui_zong'] = '财务汇总';
$_LANG['xb_hui_tong_bao'] = '汇通宝管理';
$_LANG['xb_qian_dao_ji_lu'] = '签到记录';
$_LANG['05_xb_area_list'] = '地区释放比例列表';
