...
$_LANG['ad_position'] = '广告位管理';
$_LANG['ad_position_list'] = '广告位列表';

$_LANG['ad_list'] = '广告管理';
$_LANG['ad_list_list'] = '广告列表';
...
$_LANG['article_manage_list'] = '文章内容列表';

$_LANG['shopinfo_manage'] = '网店信息管理';
$_LANG['shopinfo_manage_list'] = '网店信息列表';

$_LANG['shophelp_manage'] = '网店帮助管理';
$_LANG['shophelp_manage_list'] = '网店帮助列表';
...
$_LANG['user_rank_list'] = '会员等级列表';
$_LANG['feedback_priv'] = '会员留言管理';
$_LANG['feedback_priv_list'] = '会员留言列表';

$_LANG['surplus_manage'] = '会员余额管理';
$_LANG['surplus_manage_list'] = '会员余额列表';


$_LANG['account_manage'] = '会员账户管理';
$_LANG['account_manage_list'] = '会员账户列表';

$_LANG['user_blanklist'] = '会员小黑屋';
$_LANG['user_blanklist_list'] = '会员小黑屋列表';
// 权限管理部分的权限
$_LANG['admin_manage'] = '管理员添加/编辑';
$_LANG['admin_manage_list'] = '管理员列表';

$_LANG['admin_drop'] = '删除管理员';
$_LANG['allot_priv'] = '分派权限';
$_LANG['logs_manage'] = '管理日志管理';
$_LANG['logs_manage_list'] = '管理日志列表';
...
$_LANG['role_manage_list'] = '角色列表';

$_LANG['area_cat'] = '地区管理';

// 系统设置部分权限
$_LANG['shop_config'] = '商店设置';
$_LANG['shop_config_mail_view']='邮件服务器配置查看';
$_LANG['shop_config_list'] = '商店设置列表';

//$_LANG['shop_authorized'] = '授权证书';
$_LANG['webcollect_manage'] = '网罗天下管理';
$_LANG['ship_manage'] = '配送方式管理';
$_LANG['ship_manage_list'] = '配送方式列表';

$_LANG['payment'] = '支付方式管理';
$_LANG['payment_list'] = '支付方式列表';

$_LANG['shiparea_manage'] = '配送区域管理';

$_LANG['shiparea_manage_list'] = '配送区域列表';

$_LANG['area_manage'] = '地区列表管理';
$_LANG['area_manage_list'] = '地区列表';
$_LANG['friendlink'] = '友情链接管理';
$_LANG['users_role'] = '前台用户权限管理';
$_LANG['users_role_list'] = '前台用户权限列表';
$_LANG['captcha_manage_view'] = '验证码设置视图';
...
$_LANG['flash_manage_list'] = '首页主广告列表'; // Flash 播放器管理



$_LANG['navigator'] = '自定义导航栏管理';
$_LANG['navigator_list'] = '自定义导航栏列表';
$_LANG['cron'] = '计划任务管理';
$_LANG['cron_list'] = '计划任务列表';
...
$_LANG['order_view'] = '订单管理';
$_LANG['order_view_list'] = '订单列表';
...
$_LANG['delivery_view'] = '发货单管理';
$_LANG['delivery_view_list'] = '发货单列表';
$_LANG['13_order_statics'] = '自营订单统计';
$_LANG['02_supplier_order_list'] = '入驻商订单列表';
$_LANG['02_supplier_order'] = '入驻商订单管理';


$_LANG['back_view'] = '退货管理';
$_LANG['back_view_list'] = '退货列表';

/* 增值税发票_添加_START_www.68ecshop.com */
$_LANG['invoice_manage'] = '发票管理';
$_LANG['invoice_manage_list'] = '发票列表';
...
$_LANG['exchange_goods'] = '积分商城商品管理';
$_LANG['exchange_goods_list'] = '积分商城商品列表';
$_LANG['pre_sale'] = '预售管理';
...
$_LANG['template_setup_list'] = '模板列表';
...
$_LANG['customer'] = '客服管理';
$_LANG['third_customer'] = '第三方客服管理';
$_LANG['third_customer_list'] = '第三方客服列表';
//虚拟团购
$_LANG['virtual'] = '虚拟团购';
...
$_LANG['13_offline']="线下订单";
$_LANG['offline_view']="线下订单";
...
$_LANG['2_online_suppliers_list'] = '线上商家列表';

$_LANG['3_offline_suppliers'] = '联盟商家';
$_LANG['3_offline_suppliers_list'] = '联盟列表';

$_LANG['4_city_manage'] = '城市经理管理';
$_LANG['4_city_manage_list'] = '城市经理列表';
$_LANG['5_large_area_manage'] = '大区经理管理';
$_LANG['5_large_area_manage_list'] = '大区经理列表';


$_LANG['31_scores_manage'] = '积分管理';
$_LANG['scores_manage'] = '积分管理';
$_LANG['1_scores_manage'] = '积分查看';
$_LANG['2_scores_recharge'] = '积分充值管理';
$_LANG['2_scores_recharge_list'] = '积分充值列表';
$_LANG['3_scores_exchange'] = '积分兑换';
$_LANG['3_scores_exchange_list'] = '积分兑换列表';
$_LANG['4_scores_exchange_gz'] = '基数奖励兑换';
$_LANG['income_statics'] = '收入统计';
$_LANG['1_insure'] = '投保管理';
$_LANG['1_insure_list'] = '投保列表';

$_LANG['2_mutual'] = '互助管理';
$_LANG['2_mutual_list'] = '互助列表';
$_LANG['3_mutual'] = '助人管理';
$_LANG['3_mutual_list'] = '助人列表';



$_LANG['order_statics'] = '订单统计';
