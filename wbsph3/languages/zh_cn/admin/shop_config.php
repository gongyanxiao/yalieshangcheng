...
//香柏大家庭
$_LANG['cfg_name']['bigfamily_config'] = '大家庭设置';
$_LANG['cfg_name']['bigfamily_u_m'] = '大家庭会员充值金额';
$_LANG['cfg_name']['bigfamily_d_m'] = '大家庭代理充值金额';
$_LANG['cfg_name']['fimaly_tx'] = '大家庭提现';
$_LANG['cfg_name']['fimaly_center'] = '运营中心获得奖励比例';
$_LANG['cfg_range']['fimaly_tx']['0'] = '关闭';
$_LANG['cfg_range']['fimaly_tx']['1'] = '开启';
$_LANG['cfg_name']['fimaly_tui_u1'] = '推荐大家庭会员1级推荐人奖励';
$_LANG['cfg_name']['fimaly_tui_u2'] = '推荐大家庭会员2级推荐人奖励';
$_LANG['cfg_name']['fimaly_tui_u3'] = '推荐大家庭会员3级代理推荐人奖励';

$_LANG['cfg_name']['fimaly_tui_d1'] = '推荐大家庭代理1级推荐人奖励';
...
//养老图片
$_LANG['cfg_name']['yanglaiimg_10'] = '100000元保额';
$_LANG['cfg_name']['yanglaiimg_20'] = '200000元保额';
$_LANG['cfg_name']['yanglaiimg_30'] = '300000元保额';
...
$_LANG['cfg_name']['give_set'] = '赠送设置';
$_LANG['cfg_name']['give_open'] = '是否开启';
$_LANG['cfg_range']['give_open']['0'] = '否';
$_LANG['cfg_range']['give_open']['1'] = '是';
$_LANG['cfg_name']['give_bl'] = '赠送比例';
$_LANG['cfg_name']['give_set_points'] = '赠送积分数';
$_LANG['cfg_desc']['give_set_points'] = '单个赠送权赠送的积分数量,赠送积分数存在时，以积分数量为准';
$_LANG['cfg_name']['zuo_dan_give_set_points'] = '做单的人赠送积分数';
$_LANG['cfg_desc']['zuo_dan_give_set_points'] = '做单的人赠送的积分数和没做单的一般是不一样的';

$_LANG['cfg_desc']['give_bl'] = "商家上一个工作日的总服务费用的百分比";
$_LANG['cfg_name']['give_time'] = '赠送时间点';


$_LANG['cfg_name']['tx_set'] = '提现设置';
$_LANG['cfg_name']['tx_set_je'] = '提现金额倍数设置';
$_LANG['cfg_desc']['tx_set_je'] = '提现金额必须满足当前设置的倍数才可以进行提现';


$_LANG['cfg_name']['recommend_set'] = '推荐设置';
$_LANG['cfg_name']['recommend_set_open'] = '是否开启';
$_LANG['cfg_range']['recommend_set_open']['0'] = '否';
$_LANG['cfg_range']['recommend_set_open']['1'] = '是';
$_LANG['cfg_name']['recommend_set_percent'] = '赠送比例';
$_LANG['cfg_desc']['recommend_set_percent'] = '被推荐人确认收货后消费的总订单金额的百分比';


$_LANG['cfg_name']['zuodan_set'] = '做单设置';
// $_LANG['cfg_name']['zuodan_set_open_1'] = '运营中心是否开启做单';
// $_LANG['cfg_range']['zuodan_set_open_1']['0'] = '否';
// $_LANG['cfg_range']['zuodan_set_open_1']['1'] = '是';
// $_LANG['cfg_name']['zuodan_set_open_2'] = '商家是否开启做单';
// $_LANG['cfg_range']['zuodan_set_open_2']['0'] = '否';
// $_LANG['cfg_range']['zuodan_set_open_2']['1'] = '是';
$_LANG['cfg_name']['zuodan_set_max'] = '做单最大服务费上限';
$_LANG['cfg_name']['zuodan_set_fei'] = '报单费比率';
$_LANG['cfg_name']['zuodan_supp_fei'] = '城市经理获得奖励';
$_LANG['cfg_name']['zuodan_supp_tjnum'] = '商家推荐奖励需推荐多少人';
$_LANG['cfg_name']['zuodan_supp_tjnum_jl'] = '商家推荐奖励';
$_LANG['cfg_name']['xianxiabd_fei'] = '线下订单报单费';
$_LANG['cfg_name']['supplier_fei'] = '商家佣金比例';
...
$_LANG['cfg_name']['dayu_sign'] = '短信签名';
 ...
 $_LANG['cfg_name']['dayu_xiaofei'] = '线下消费是否发短信';
$_LANG['cfg_range']['dayu_xiaofei']['1'] = '发短信';
$_LANG['cfg_range']['dayu_xiaofei']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_xiaofei_tpl'] = '阿里大鱼平台申请的线下消费模板ID';
