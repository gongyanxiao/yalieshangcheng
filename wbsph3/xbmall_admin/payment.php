...
//    exit;
    foreach ($modules as $key => $value) {
        if ($value['code'] == 'alipay_bank' || $value['code'] == 'balance' || $value['code'] == 'cod' || $value['code'] == 'kuaiqian' || $value['code'] == 'kuaiqian_abc' || $value['code'] == 'kuaiqian_bcom' || $value['code'] == 'kuaiqian_bob' || $value['code'] == 'kuaiqian_boc' || $value['code'] == 'kuaiqian_ccb' || $value['code'] == 'kuaiqian_cmb' || $value['code'] == 'kuaiqian_cmbc' || $value['code'] == 'kuaiqian_sdb' || $value['code'] == 'tenpay' || $value['code'] == 'unionpay' || $value['code'] == 'tenpayc2c'||$value['code']=="yeepay"||$value['code']=='yeepayszx'
                ||$value['code']=='yeepay_abchina'
                ||$value['code']=='yeepay_ccb'
                ||$value['code']=='yeepay_cmbchina'
                ||$value['code']=='yeepay_icbc'
                ||$value['code']=='yeepay_jcard'
                ||$value['code']=='kuaiqian_icbc'
                 ||$value['code']=='wxnative'
                 ||$value['code']=='post') {
            unset($modules[$key]);
        }
