...
/* 操作 */ elseif ($_REQUEST['act'] == 'operate') {
    /* 检查权限 */
    admin_priv('back_view');
...
/* 操作--退款 */ elseif ($_REQUEST['act'] == 'operate_refund') {
    /* 检查权限 */
    admin_priv('back_view');
    $status_refund = '1';
    $back_id = intval(trim($_REQUEST['back_id']));        // 退换货订单id
...
/* 删除退换货订单 */ elseif ($_REQUEST['act'] == 'remove_back') {
...
/* 回复客户留言 */ elseif ($_REQUEST['act'] == 'replay') {
