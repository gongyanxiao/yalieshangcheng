...
$modules['03_promotion']['hd_chou_jiang'] = 'xxtz_hd_chou_jiang.php?act=list';
...
$modules['04_order']['12_order_statics'] = 'order_statics.php?act=list'; // 订单统计
$modules['04_order']['13_order_statics'] = 'order.php?act=statics_list'; // 自营订单统计
// $modules['04_order']['12_order_statics_up'] = 'order_statics_up.php?act=list'; // 商家线上订单统计
//$modules['04_order']['13_offline'] = 'offline.php?act=list';
// $modules['04_order']['13_offline'] = 'order_statics_down.php?act=list';
...
$modules['07_content']['09_topic'] = 'topic.php?act=list';
...
//$modules['11_system']['area_cat']             = 'area_cat.php';
...
//$modules['11_system']['22_large_area'] = 'large_area.php?act=list';
$modules['11_system']['23_users_role'] = 'users_role.php?act=list';
...
// $modules['12_template']['04_template_library'] = 'template.php?act=library';//库项目管理
// $modules['12_template']['05_edit_languages'] = 'edit_languages.php?act=list';//语言项编辑
...
// $modules['11_system']['third_customer'] = 'third_customer.php?act=list'; // 三方客服
/*账号管理*/
$modules['30_accounts_manage']['user_blanklist'] = 'user_blacklist.php?act=list';
$modules['30_accounts_manage']['1_user_manage'] = 'users.php?act=list&stype=edit'; // 用户管理
$modules['30_accounts_manage']['2_online_suppliers'] = 'supplier.php?act=list&status=1&stype=3'; // 线上商家
$modules['30_accounts_manage']['3_offline_suppliers'] = 'supplier.php?act=list&status=1&stype=4'; // 联盟商家
$modules['30_accounts_manage']['4_city_manage'] = "area_cat.php"; //城市经理管理
$modules['30_accounts_manage']['5_large_area_manage'] = "large_area.php?act=list"; //大区经理管理


/*积分管理*/
// $modules['31_scores_manage']['1_scores_manage'] = 'users.php?act=list&stype=view'; // 积分查看
// $modules['31_scores_manage']['2_scores_recharge'] = 'user_account.php?act=list&process_type=0&is_paid=1&type=-1'; // 积分充值
// $modules['31_scores_manage']['3_scores_exchange'] = 'user_account.php?act=list&process_type=1&ti_xian_type=-1'; // 所有积分兑换


// $modules['31_scores_manage']['3_scores_exchange'] = 'user_account.php?act=list&stype=1'; // 积分兑换
// $modules['31_scores_manage']['4_scores_exchange_gz'] = 'user_account.php?act=list&stype=1&atype=1'; // 基数奖励提现
// $modules['31_scores_manage']['5_scores_exchange_djtfh'] = 'user_account.php?act=list&stype=1&atype=2'; // 大家庭分红奖励提现


// 财务统计
// $modules['32_finance']['finance_statics'] = 'finance_statics.php?act=list'; // 网站应收账款统计
// $modules['32_finance']['statics_dong_jie'] = 'statics_dong_jie.php?act=list'; // 消费分红权冻结
// $modules['32_finance']['income_statics'] = 'statics_income.php?act=list'; // 收入统计
// $modules['32_finance']['ji_fen_gou_wu_statics'] = 'statics_ji_fen_gou_wu.php?act=list'; // 本人积分购物统计
// $modules['32_finance']['ben_ren_statics'] = 'statics_ben_ren.php?act=list'; // 对于本人各种金额的统计
// $modules['32_finance']['tui_jian_statics'] = 'statics_tui_jian.php?act=list'; // 对于推荐人从被推荐人,获得的各种金额



/* 爱心互助 */
// $modules['33_Mutual']['1_insure'] = 'insure.php?act=list'; // 投保列表
// $modules['33_Mutual']['2_mutual'] = 'mutual.php?act=list'; // 互助列表
// $modules['33_Mutual']['3_mutual'] = 'mutual_u.php?act=list'; // 助人列表

/* 养老金 */
// $modules['34_pension']['1_pension_manage'] = 'pension_manage.php?act=list'; // 养老金管理
// $modules['34_pension']['2_pension_apply'] = 'pension_apply.php?act=list'; // 养老金申请


// $modules['tk_admin_user']['tk_admin_shen_qing'] = 'tk_user.php?act=list&type=7'; // 甜空用户申请审核
// $modules['tk_admin_user']['tk_admin_user_info'] = 'tk_user.php?act=list&type=6'; // 甜空用户列表
// $modules['tk_admin_user']['tk_admin_li_cai_list'] = 'tk_li_cai_chan_pin.php?act=list'; // 理财产品列表

// $modules['jygj']['xb_zrzcjl'] = '/xbmall_admin/xb_zrzcjl.php?act=list'; // 转入转出记录
// $modules['jygj']['xb_pu_huo_ji_lu'] = '/xbmall_admin/xb_pu_huo_ji_lu.php?act=list'; //铺货记录
// $modules['jygj']['xb_yao_qing_jiang_li'] = '/xbmall_admin/xb_yao_qing_jiang_li.php?act=list'; //铺货记录

// $modules['jygj']['xb_hui_tong_bao'] = '/xbmall_admin/xb_hui_tong_bao.php?act=list'; //汇通宝管理
// $modules['jygj']['xb_cai_wu_hui_zong'] = '/xbmall_admin/xb_cai_wu_hui_zong.php?act=list'; //财务汇总
// $modules['jygj']['xb_qian_dao_ji_lu'] = '/xbmall_admin/xb_qian_dao_ji_lu.php?act=list'; //签到记录
// $modules['jygj']['05_xb_area_list'] = '/xbmall_admin/xb_area_manage_rate.php?act=list'; //地区释放比例



// $modules['jygj']['zt_user_cj_list'] = '/jygj/mall/zt_9988_cms/zt_user_cj_list.php'; // 理财产品列表
$modules['jygj']['xxtz_cz_list'] = '/jygj/mall/zt_9988_cms/xxtz_cz_list.php'; //
// $modules['jygj']['xxtz_list'] = '/jygj/mall/zt_9988_cms/xxtz_list.php'; //
$modules['jygj']['zt_cash_exchange_cj'] = '/jygj/mall/zt_9988_cms/zt_cash_exchange_cj.php'; //
// $modules['jygj']['xxcz_fa_fang_manager'] = '/jygj/mall/zt_9988_cms/xxcz_fa_fang_manager.php'; //
// $modules['jygj']['zt_setting_list'] = '/jygj/mall/zt_9988_cms/zt_setting_list.php'; //
// $modules['jygj']['xxtzzs_list'] = '/jygj/mall/zt_9988_cms/xxtzzs_list.php'; //
// $modules['jygj']['xxtz_tree'] = '/jygj/mall/zt_9988_cms/xxtz_tree.php'; //
// $modules['jygj']['tong_ji'] = '/jygj/mall/zt_9988_cms/tong_ji.php'; //
// $modules['jygj']['tong_ji_fen_hong'] = '/jygj/mall/zt_9988_cms/tong_ji_fen_hong.php'; //

// $modules['jygj']['tui_jian_jiang_fa_huo'] = '/jygj/mall/zt_9988_cms/tui_jian_jiang_fa_huo.php'; //

// $modules['04_order']['cai_gou_ding_dan'] = 'cai_gou_ding_dan.php?act=list'; //采购订单
// $modules['04_order']['ru_ku_ding_dan'] = 'cai_gou_ding_dan.php?act=list_cang_chu';  // 入库订单
// $modules['04_order']['ru_ku_chu_ku_tong_ji'] = '/jygj/mall/zt_9988_cms/ru_ku_chu_ku_tong_ji.php'; //出入库统计
