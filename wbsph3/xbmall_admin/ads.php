...
//     $smarty->assign('district_list', get_regions(3, $supplier['city']));
    /* 创建 html editor */
    create_html_editor('FCKeditor1',htmlspecialchars('')); /* 修改 */
...
//             $ad_code = $_POST['ad_code'];
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (province_id,city_id,district_id,position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_email,link_phone,click_count,enabled)
    VALUES (
   		    '$province_id',
    		'$city_id',
    		'$district_id',
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('province_list', get_regions(1, 1));
    $smarty->assign('city_list', get_regions(2, $ads_arr['province_id']));
    $smarty->assign('district_list', get_regions(3, $ads_arr['city_id']));
    
    /* 创建 html editor */
    create_html_editor('FCKeditor2',htmlspecialchars($ads_arr['ad_code'])); /* 修改 */
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    elseif ($type == 2)
    {
    	$ad_code = "ad_code = '$_POST[FCKeditor2]', ";
    }
...
function get_adslist()
{
    ...
    $filter['province_id']	  = intval($_REQUEST['province_id']);
    $filter['city_id']	  = intval($_REQUEST['city_id']);
    $filter['district_id']	  = intval($_REQUEST['district_id']);
    ...
    {
    	$where.="AND ad.province_id =".$filter['province_id']." ";
    }
    ...
    {
    	$where.="AND ad.district_id =".$filter['district_id']." ";
    }
